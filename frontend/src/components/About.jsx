  ...
  return (
    <div className="sm:mb-48">
      ...
      <div class="-mt-4 p-6 flex flex-col lg:flex-row items-center justify-center">
        <img src={aboutImg} alt="" class="w-full md:w-md max-w-lg" data-testid="imgAbout" />

        <div class="w-auto h-full max-w-lg p-6 bg-blue">
          <h2 class="text-2xl text-white font-bold mb-4" data-testid="heading">About Us</h2>

          <p className="text-white mb-7 text-sm" data-testid="about-text">
          ...
          <p className="text-white mb-5 text-sm" data-testid="about-text">
